...
const DashboardHeader = ({ mobileMenu, setMobileMenu, userRole }) => {
  ...
  return (
    <>
      <header id={styles.header}>
        <div id={styles.toggleMenuBtn}>
          {mobileMenu ? (
            ...
            <i class="fa-solid fa-bars" onClick={() => setMobileMenu(true)}></i>
          )}
        </div>
        <div>
          ...
          {showMenu && (
            <div>
              {userRole === "host" && (
                <>
                  <h4>
                    I am {available ? "available" : "unavailable"} to host
                  </h4>
                  <input
                    type="checkbox"
                    id="available"
      ...
      {showProfileModal && (
        <ModalLg setModal={setProfileModal}>
      ...
      {showModalLg === "license" && (
        <ModalLg setModal={setShowModalLg}>
          <div className={styles.modalLgBox}>
            ...
            <p>
              Your driver's license is currently <span>active</span> and{" "}
              <span>approved</span>. You can revise your information by
              selecting edit icon, make the changes, and select OK to save.
              Please allow up to 24hours for your new information to be reviewed
              for approval.
              <br />
              <br />
            ...
            {editLicense && (
              <>
                <div className={styles.modalCheckbox}>
                  ...
                  <label htmlFor="">
                    I agree to VEHDE's <Link href="">Terms of Use</Link> and
                ...
                <div className={styles.modalBtnBox}>
                  ...
                  <button
                    className={styles.modalBtnSuccessOutline}
                    onClick={() => {
                      setEditLicense(false);
                      setShowModalLg(false);
                    }}
      ...
      {showModalLg === "contact" && (
        <ModalLg setModal={setShowModalLg}>
          <div className={styles.modalLgBox}>
            ...
            <p>
              Your contact information is currently <span>complete</span> and{" "}
              <span>approved</span>. You can revise your information by
              selecting edit icon, make the changes, and select OK to save.
              Please allow up to 24 hours for your new information to be
      ...
      {showModalMd === "auto" && (
        <ModalLg setModal={setShowModalMd}>
          <div className={`${styles.modalLgBox}`}>
            <h2>
              VEHDE
            ...
            >
              VEHDE makes protection plans available to guests. Details of the
              protection plans can be found by reviewing
            </p>
            <p style={{ fontSize: "12px", color: "#6A6A6A" }}>
              Understanding and choosing ride auto protection.
            </p>
            ...
            >
              Guests that want supplemental protection may purchase personal
              coverage as <span style={{ color: "#6A6A6A" }}>Add-On</span>
            </p>

            <p
              style={{ fontSize: "15px", color: "#6A6A6A", marginTop: "40px" }}
            >
              {" "}
              Please select a reservation, from the list of your existing
              reservations, for which you want to review it's Add-On coverage.
            </p>
            ...
            <div className={PaymentPageStyles.searchBox}>
              ...
              <input
                type="text"
                placeholder="Enter the reserved car name"
                onChange={() =>
                  setPayFeesAndAddOnModal(
                ...
                value={"2022 Toyota Venza"}
              />
            </div>
            <ProtectionBox
              hideTitle={true}
              customStyles={{ padding: "15px" }}
            />
      ...
      {showModalMd !== "auto" &&
        showModalMd !== null &&
        showModalMd !== false && (
          <ModalMd setModal={setShowModalMd}>
            {showModalMd === "password" && (
              <div className={styles.modalLgBox}>
                <h2>
                  VEHDE
                ...
                <p style={{ fontSize: "12px", color: "#6A6A6A" }}>
                  Password must be between 8-20 characters, and include at least
                  one lowercase letter, once UPPERCASE letter, and one number
                </p>
                <div className="mt-4">
                  <button
                    className="my-btn w-100"
                    onClick={() => setShowModalMd("authorization")}
                  >
                    Change Password
                  </button>
                </div>
            ...
            {showModalMd === "authorization" && (
              <div className={styles.modalLgBox}>
                <h2>VEHDE</h2>
                <p style={{ textAlign: "center" }}>
                  An Authorization code was sent to your mobile phone number
                </p>
                ...
                <div className="mt-3">
                  <button
                    className="my-btn w-100"
                    onClick={() => setShowModalMd("password changed")}
                  >
                    Change Password
                  </button>
                </div>
            ...
            {showModalMd === "password changed" && (
              <div className={`${styles.modalLgBox} text-center`}>
