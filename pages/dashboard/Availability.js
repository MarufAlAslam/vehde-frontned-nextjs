    ...
    <>
      <DashboardLayout>
        <div className={styles.container}>
          <DashboardBanner
            leftContent={<DashboardBannerLeftContent page="availability" />}
            rightContent={<DashboardBannerRightContent page="availability" />}
          />
                ...
                <tbody>
                  {listings.map((listing) => (
                    <tr>
                      ...
                      <td>{listing.availability.split("-")[0]}:00</td>
                      <td>{listing.availability.split("-")[1]}:00</td>
                      <td>{listing.state}</td>
                      <td>{listing.city}</td>
                    </tr>
                  ))}
          ...
          {/* <div className={styles.buttons}>
            {isEditMode ? (
              <>
                <button className="my-btn" onClick={() => setIsEditMode(false)}>
                  Save
                </button>
                <button className="my-btn" onClick={() => setIsEditMode(false)}>
                  Cancel
              ...
              <button className="my-btn" onClick={() => setIsEditMode(true)}>
                Edit
              </button>
            )}
          </div> */}
