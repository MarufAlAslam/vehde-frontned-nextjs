...
const CarListing = () => {
  ...
  const handleCarListing = (e) => {
    ...
    const rentperday = form.rentperday.value;
    const rentperhour = form.rentperhour.value;
    const erh = form.erh.value;
    ...
    <>
      <DashboardLayout>
        <div className={styles.wrapper}>
          <h2>
            Please complete the information below for listing your car to host
            with VEHDE.
          </h2>
          <form onSubmit={handleCarListing}>
            <div className={styles.formWrapper}>
              ...
              <div className="mb-3">
                ...
                <div>
                  ...
                  <button
                  // onClick={() => setModal("schedule1")}
                  >
                    {startDate1
                      ? startDate1?.toLocaleDateString()
                      : "Add schedule"}{" "}
                    {startTime1}
                  </button>
                </div>
              ...
              <div className="mb-3">
                ...
                <div className={styles.inputBox}>
                  <label htmlFor="">Rush hour rent rate ($/hour)</label>
                  <input
                    type="text"
                    name="rentperhour"
                    placeholder="Enter your rate"
                ...
                <div className={styles.inputBox}>
                  ...
                  <input type="text" name="erh" placeholder="Enter your rate" />
                </div>
                <div className={styles.inputBox}>
              ...
              <div className="mb-4">
                <div className={styles.inputBox}>
                  <textarea
                    ...
                    id=""
                    maxLength={200}
                    placeholder="A brief description about yourself. No more than 200 characters*"
                  ></textarea>
                </div>
                <button
                  type="button"
                  className={styles.inputBox}
                  onClick={() => setUploadCarPictures({})}
                >
      ...
      {uploadCarPictures && (
        <UploadCarPictures
          setUploadCarPictures={setUploadCarPictures}
          setModalLg={setModalLg}
        ></UploadCarPictures>
      )}
      ...
      {modalLg && (
        <ModalLg
          setModal={setModalLg}
          title="Host | Car pictures & specifications"
          subtitle="Please preview your car pictures."
        >
          ...
          <CarDetailsPopupOverview
            setCarDetailPopupOverview={setCarDetailPopupOverview}
          />
      ...
      {carDetailPopupOverview && (
        <>
          <ModalMd
            title={`Host Category: Individual`}
            setModal={setCarDetailPopupOverview}
          >
